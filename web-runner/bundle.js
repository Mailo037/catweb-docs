...
exports.formatUDimCss = formatUDimCss;
 ...
 */
function applyBackgroundStyling(domElement, bgColor, bgTrans) {
 ...
 */
function applyTextStyling(domElement, fontColor, fontTrans) {
  if (!domElement || !domElement.style) return;
...
const { applyBackgroundStyling, applyTextStyling } = require('./styling.js');
...
exports.initAiProtocol = initAiProtocol;
  ...
  './overflow_menu.js': function(module, exports, require) {
/**
...
const OVERFLOW_CONFIG = exports.OVERFLOW_CONFIG = [
...
/* Module Exports */
exports.CatWebOverflowManager = CatWebOverflowManager;
exports.OVERFLOW_CONFIG = OVERFLOW_CONFIG;
